...
DAYS_NO_CONNECTIVITY_MAX = 14  #92 do not allow to engage after 2 weeks without internet
DAYS_NO_CONNECTIVITY_PROMPT = 7  #31 send an offroad prompt after 10 days with no internet
